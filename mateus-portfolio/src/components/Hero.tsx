...
Estudante de Engenharia Aeroespacial na UFMG. Focado em projeto mecânico, simulações aerodinâmicas (CFD/FEA) e arquitetura de hardware. Unindo o rigor da engenharia física ao desenvolvimento de firmware, sistemas embarcados e IoT para criar soluções multidisciplinares. Além dos projetos detalhados abaixo, este próprio site foi desenvolvido integralmente por mim do zero, servindo como a primeira demonstração prática deste portfólio.         </motion.p>
